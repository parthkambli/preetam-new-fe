      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          ...
          <Select
            ...
            onChange={(sel) => onChange(index, "staff", sel?.value || "")}
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const serialized = form.activityFees.map((af) => ({
        ...
        endDate: af.endDate,
        membershipStatus: af.membershipStatus,
        staff: af.staff,
      }));
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-white rounded-xl shadow p-6 sm:p-8 max-w-5xl space-y-8">
        ...
        {/* Membership (Top Level - unchanged) */}
        {/* <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input type="date" name="endDate" value={form.endDate || ""} onChange={handleChange}
                min={form.startDate || ""} max="9999-12-31"
            ...
            <div>
              ...
              <Select
                ...
                onChange={(sel) => setForm((prev) => ({ ...prev, staff: sel?.value || "" }))}
