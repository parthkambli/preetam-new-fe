...
const ActivityFeeRow = ({
  ...
  const handlePlanChange = (e) => {
    ...
    const autoFee  = entry.feeType?.data && planMeta
...
//     // Auto-fill end date when plan changes (if start date already set)
//     if (entry.startDate) {
//       const newEnd = computeEndDate(entry.startDate, newPlan);
//       if (newEnd) onChange(index, "endDate", newEnd);
//     }
//   };

//   const handleStartDateChange = (e) => {
//     const newStart = e.target.value;
//     onChange(index, "startDate", newStart);

//     // Auto-fill end date based on plan
//     if (newStart && entry.plan) {
//       const newEnd = computeEndDate(newStart, entry.plan);
//       if (newEnd) onChange(index, "endDate", newEnd);
//     }
