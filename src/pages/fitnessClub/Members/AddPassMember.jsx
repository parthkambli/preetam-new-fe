  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">{isEdit ? "Edit Pass Member" : "Add Pass Member"}</h1>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <input
                type="text" name="numberOfPersons" value={form.numberOfPersons} onChange={handleChange}
                placeholder="e.g. 2"
