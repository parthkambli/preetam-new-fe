...
//   Attendence: ["view", "mark"], // 🔥 CUSTOM ACTION
// };
...
//       m,
//       Object.fromEntries(
//         MODULE_ACTIONS[m].map((a) => [a, false])
//       ),
//     ])
//   );
...
//         status: editingUser.isActive === "Yes" ? "Active" : "Inactive",
//       });
...
//       // 🔥 Special case
//       if (module === "Attendence" && action === "mark") {
...
//     // 🔹 Update permissions
//     const customPermissions = mapToPermissions(permissions);
...
//               className={
//                 customPermissions.includes(`${cap.toUpperCase()}_${module.toUpperCase().replace(/\s+/g, "_")}`)
//                   ? "accent-green-600"
//                   : rolePermissions.includes(`${cap.toUpperCase()}_${module.toUpperCase().replace(/\s+/g, "_")}`)
//                   ? "accent-blue-600"
//                   : ""
//               }
//             />
