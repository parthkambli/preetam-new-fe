...
export default function StaffNavigation() {
  const { user, isFitnessStaff } = useOrg();
  ...
  const flowSteps = [
    {
      ...
      icon: "Login",
      status: "completed",
      details: "Use your FITSTF#### ID and default password: staff123"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      icon: "Users",
      status: "available",
      details: "Access member records and subscription details"
    },
    {
      id: 4,
      title: "Activities Management",
      description: "Schedule and manage fitness activities",
      path: "/fitness/activities",
      icon: "Target",
      status: "available",
      details: "Create and track fitness classes and programs"
    },
    {
      id: 5,
      title: "Attendance Tracking",
      description: "Mark and view attendance records",
      path: "/fitness/attendance",
      icon: "Calendar",
      status: "available",
      details: "Daily attendance for members and activities"
    },
    {
      id: 6,
      title: "Events Management",
      description: "Organize and track fitness events",
      path: "/fitness/events",
      icon: "Calendar",
      status: "available",
      details: "Create and manage fitness events and competitions"
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 text-white mb-6">
          ...
          <p className="text-green-100">
            Complete guide to your Fitness Staff workflow and access
          </p>
        ...
        <div className="mt-8 bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <button
              onClick={() => navigate("/fitness/activities")}
            ...
            <button
              onClick={() => navigate("/fitness/attendance")}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-700 text-sm">
                ...
                Default login credentials: Staff ID (FITSTF####) and password (staff123)
              </p>
            </div>
          </div>
        </div>
