// // pages/school/Events/AddEvent.jsx
// import { useState, useEffect } from "react";
// import { useNavigate, useLocation } from "react-router-dom";
// import { toast } from 'sonner';
// import { api } from '../../../services/apiClient';

// const EVENT_TYPES = ["Birthday", "Lunch", "Health Camp", "Festival", "Sports", "Other"];
...
//     try {
//       if (editingEvent) {
//         await api.events.update(editingEvent._id, form);
...
//       }
//       setSubmitted(true);
//       setTimeout(() => navigate("/school/events"), 1200);
//     } catch (err) {
...
export default function AddEvent() {
  ...
  // Set default date to today for new events (runs once on mount)
  useEffect(() => {
    if (!editingEvent) {
