...
//       const response = await api.schoolStaffPanel.getFollowups(params);
...
useEffect(() => {
  ...
  const fetchActivities = async () => {
    try {
      const res = await api.schoolStaffPanel.getActivities();
...
setTotalCount(
  ...
  const fetchUpcomingFollowups = async () => {
    try {
      const response = await api.schoolStaffPanel.getFollowups({ upcoming: true, enquiryType: 'school' });
  ...
  const handleSubmitRemark = async (e) => {
    ...
    try {
      await api.schoolStaffPanel.createFollowup({
        enquiryType: 'school',
        enquiryId: selectedFollowup.enquiryId,
        personName: selectedFollowup.personName,
        mobile: selectedFollowup.mobile,
