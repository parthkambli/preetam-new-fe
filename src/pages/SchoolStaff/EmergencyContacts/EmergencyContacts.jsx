...
export default function EmergencyContacts() {
  ...
  const fetchContacts = async () => {
    try {
      setLoading(true);
      const res = await api.schoolStaffPanel.getStudents();   // This matches exports.getAllStudents
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await api.schoolStaffPanel.updateEmergencyContact(modal.contact._id, {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await api.schoolStaffPanel.clearEmergencyContact(modal.contact._id);
