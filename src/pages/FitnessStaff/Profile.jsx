...
export default function StaffProfilePage() {
  const staff = {
    ...
    email: "meena@seniorcare.org",
    role: "Yoga Instructor",
    assignedActivities: ["Yoga", "Group Exercise"],
    profileImage:
          ...
          <Card className="p-6 sm:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-10">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-5">
                  <div className="bg-[#F3F0FA] rounded-2xl p-5">
                    ...
                    <div className="space-y-2 text-gray-700">
                      <p><span className="font-medium text-black">Name:</span> {staff.name}</p>
                      <p><span className="font-medium text-black">Contact:</span> {staff.phone}</p>
                      <p><span className="font-medium text-black">Email:</span> {staff.email}</p>
                    </div>
                  </div>
                ...
                <button className="mt-8 bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-xl font-medium transition">
                  Log out
                </button>
              </div>
            </div>
