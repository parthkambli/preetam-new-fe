  ...
  return (
    <div className="border border-gray-200 rounded-xl p-4 bg-gray-50 relative">
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <span
          className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold ${activityStatus === "Active" ? "bg-green-100 text-green-700" : "bg-gray-200 text-gray-500"}`}
        >
          {activityStatus}
        </span>
      </div>
        ...
        if (
          ...
          activityFees = member.activityFees.map((af) => {
            ...
            return {
              ...
              paymentMode: ["Cash", "Bank Transfer"].includes(af.paymentMode)
                ? af.paymentMode
                : "",
